...
const events = [
  ...
  },
  {
    ...
    date: 2026,
    title: 'Raycast Ambassador',
    description: 'I\'ve become a French ambassador for Raycast, a tool I absolutely love.'
  },
  {
    icon: 'i-lucide-gamepad-2',
    title: 'Raftou',
    link: 'https://www.raftou.com/',
    description: 'Development of a solo iOS/Android mobile game over a period of five months on a full-time basis.'
  },
]
...
<template>
  <div class="w-full h-70 mb-8 lg:mb-20">
    ...
    <div class="lg:hidden relative px-4">
      ...
      <!-- Détails de l'event sélectionné -->

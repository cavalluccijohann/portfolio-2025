...
<template>
  ...
  >
    ...
    <div class="w-full mx-4 sm:px-0 sm:w-1/3 h-[1px] bg-primary mx-auto mb-2" :class="draw ? 'hidden' : ''" />
    <div class="w-1/2 sm:w-1/2 mx-auto flex items-center justify-center gap-4 sm:gap-6" :class="draw ? 'hidden' : ''">
      <Socials />
    </div>
  </div>
</template>
